...
public class D09_CollectEmail {
	...
	*/
	...
	public static void main(String[] args) {
		...
		TreeSet<String> find_email = new TreeSet<>();
		ArrayList<String> find_email2 = new ArrayList<>();
		
		while(matcher.find()) {
			System.out.println("찾은 것: " + matcher.group());
			find_email.add(matcher.group());
			find_email2.add(matcher.group());
		...
		for(String a : find_email2) {
				
			//만약 firstList에 String a 와 동일한 값이 없을 경우
			if(!firstList.contains(a)) {
				//find_email2의 값을 저장
				firstList.add(a);
				
			//만약 firstList에 String a 와 동일한 값이 있을 경우
			}else {
				//find_email2의 ※중복된 값을 저장
				secondList.add(a);
			}
		}
		...
		System.out.println(find_email.size());
	}
}
