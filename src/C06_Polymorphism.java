...
public class C06_Polymorphism {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.println("f가 Fruit이 될 수 있는 인스턴스인가요? "+(f instanceof Pineapple));
		System.out.println("f가 Fruit이 될 수 있는 인스턴스인가요? "+(f instanceof DragonFruit));
		
		System.out.println("f2가 Fruit이 될 수 있는 인스턴스인가요? "+(f2 instanceof Fruit));
		System.out.println("f2가 Fruit이 될 수 있는 인스턴스인가요? "+(f2 instanceof Pineapple));
		System.out.println("f2가 Fruit이 될 수 있는 인스턴스인가요? "+(f2 instanceof DragonFruit));
	}
}
