	...
	public static void main(String[] args) {
		 	...
		 	# 정수 타입
		 	 - byte		(1byte)	-128 ~ +127
		 	 	...
		 	 	1byte => 8bit
		 	  	...
		 	  	0000 0000(0) ~ 1111 1111(255) (부호가 없는경우 0 ~ 255까지 표현 가능)
		 	 ...
		 	 - char 	(2byte unsigned 부호없음) 0 ~ 65,535 ※ 문자 코드 저장용
		...
		/*
		 	# 참/거짓 타입
		 	 ...
		 	 들어갈 수 있는 값은 true 와 false 밖에 없다
		 */
		boolean male = true;
		boolean female = true;
		...
		char ch2 = 'x';
		int num ='x';
		System.out.println("char에 저장된 값: " + ch);
		System.out.println("'x'를 저장한 char 타입 변수의 출력: " + ch2);
		System.out.println("'x'를 저장한 int 타입 변수의 출력: " + num);
	}
}
