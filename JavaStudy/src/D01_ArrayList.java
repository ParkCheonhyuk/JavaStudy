...
public class D01_ArrayList {
	/*
		...
		# java.util.ArrayList
		 ...
		 - 배열과 유사하지만 크기가 자동적으로 조절되는 자료구조 클래스
		 - 배열처럼 데이터를 순차적으로 저장한다
		 - 순차적으로 모든 데이터를 접근해야 할 때 가장 유리하다
	*/
	public static void main(String[] args) {
		
		/*
		  	# 타입을 지정하며 ArrayList 생성하기
		  	 - 타입을 지정할 때 사용하는 <>를 제너릭(Generic)이라고 부른다
		  	 - 해당 클래스 내부의 아직 지정됮 않은 타입을 지정하는 문법이다
		  	 - 제너릭에는 기본형 타입을 사용할 수 없다 
		*/
