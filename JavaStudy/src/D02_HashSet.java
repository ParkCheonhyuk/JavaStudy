...
public class D02_HashSet {
	...
	/*
	 	...
	 	# Hash
	 	 ...
	 	 - 비슷한 다른 값을 넣더라도 전혀 예측이 불가능한 값이 나와야 한다
	...
	*/
	...
	public static void main(String[] args) {
		...
		// Set에는 index가 없기 때문에 값으로만 지울 수 있다
		numbers.remove(50);
		...
		// Collections.addAll(Collection) : 컬렉션의 모든 내용을 다른 컬렉션에 추가하기
		...
		// Collections.removeAll(Collection) : 전달한 컬렉션과 같은 내용을 모두 제거
